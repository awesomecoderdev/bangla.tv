...
export default function RootLayout({ children }) {
	return (
		<html lang="en">
			<head />
			<body className="antialiased text-slate-500 dark:text-slate-400  bg-zinc-50 dark:bg-slate-900 h-full ">
				<header className="w-full bg-white dark:bg-gray-900 border-b border-slate-300 dark:border-slate-800">
					<div className="container relative flex flex-col px-6 py-4 mx-auto">
						<nav className="md:flex md:items-center md:justify-between">
							<div className="flex items-center justify-between">
								...
								<Link href="/">
									<Image
										...
										src="https://banglatv.tv/wp-content/uploads/2020/09/banglatvlogo.png"
							...
							<div className="absolute inset-x-0 z-20 w-full px-6 py-8 mt-8 space-y-6 transition-all duration-300 ease-in-out bg-white dark:bg-gray-900 top-16 md:bg-transparent md:dark:bg-transparent md:mt-0 md:p-0 md:top-0 md:relative md:w-auto md:opacity-100 md:translate-x-0 md:space-y-0 md:-mx-6 md:flex md:items-center">
								...
								<Link
									target="_blank"
									href="https://youtube.com/@awesomecoderdev"
									className="w-full px-5 py-3 transition-colors duration-300 bg-gray-100 rounded-md dark:bg-gray-800 md:w-auto md:mx-6 hover:bg-gray-200 dark:hover:bg-gray-700"
								>
